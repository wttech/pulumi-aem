...
1. AWS EC2 instance with private IP
    * [Node.js](https://github.com/wttech/pulumi-aem-native/tree/main/examples/nodejs_aws_ssm)
    * [GoLang](https://github.com/wttech/pulumi-aem-native/tree/main/examples/go_aws_ssm)
2. AWS EC2 instance with public IP
    * [Node.js](https://github.com/wttech/pulumi-aem-native/tree/main/examples/nodejs_aws_ssh)
    * [GoLang](https://github.com/wttech/pulumi-aem-native/tree/main/examples/go_aws_ssh)
3. Bare metal machine
    * [Node.js](https://github.com/wttech/pulumi-aem-native/tree/main/examples/nodejs_bare_metal)
    * [GoLang](https://github.com/wttech/pulumi-aem-native/tree/main/examples/go_bare_metal)
