...
namespace WTTech.Aem
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/wttech/pulumi-aem";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("WTTech.Aem.version.txt");
    ...
    internal sealed class AemResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AemResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
